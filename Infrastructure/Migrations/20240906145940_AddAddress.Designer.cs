...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240906145940_AddAddress")]
            ...
            modelBuilder.Entity("Domain.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredIn = new DateTime(2024, 9, 6, 11, 59, 37, 967, DateTimeKind.Local).AddTicks(643)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            RegisteredIn = new DateTime(2024, 9, 6, 11, 59, 37, 967, DateTimeKind.Local).AddTicks(665)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 10,
                            Code = new Guid("e59a191c-65d6-4ba2-9e41-013a79f90a41"),
                            Name = "X-Tudo",
                            Price = 20m
                        },
                        new
                        {
                            Id = 2,
                            Amount = 15,
                            Code = new Guid("8745edf2-8901-4230-bdc0-515cf8246a43"),
                            Name = "X-Egg-Bacon",
                            Price = 18m
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Discount = 0m,
                            EmployeeId = 1,
                            SaleDate = new DateTime(2024, 9, 6, 11, 59, 37, 967, DateTimeKind.Local).AddTicks(1157),
                            StatusPayment = 1,
                            StatusSale = 4,
                            TotalValue = 400m,
                            TypePayment = 3
                        ...
                        new
                        {
                            ...
                            Discount = 50m,
                            EmployeeId = 2,
                            SaleDate = new DateTime(2024, 9, 6, 11, 59, 37, 967, DateTimeKind.Local).AddTicks(1164),
                            StatusPayment = 0,
                            StatusSale = 0,
                            TotalValue = 600m,
                            TypePayment = 1
