...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240904190929_AddCart")]
            ...
            modelBuilder.Entity("Domain.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredIn = new DateTime(2024, 9, 4, 16, 9, 27, 472, DateTimeKind.Local).AddTicks(7477)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            RegisteredIn = new DateTime(2024, 9, 4, 16, 9, 27, 472, DateTimeKind.Local).AddTicks(7498)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 10,
                            Code = new Guid("2aaa63fa-9a3b-4e1a-abf1-d5b989ff8b75"),
                            Name = "X-Tudo",
                            Price = 20m
                        },
                        new
                        {
                            Id = 2,
                            Amount = 15,
                            Code = new Guid("b40c63fa-096c-4858-902d-3b2d6e36b429"),
                            Name = "X-Egg-Bacon",
                            Price = 18m
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Discount = 0m,
                            EmployeeId = 1,
                            SaleDate = new DateTime(2024, 9, 4, 16, 9, 27, 472, DateTimeKind.Local).AddTicks(8206),
                            StatusPayment = 1,
                            StatusSale = 4,
                            TotalValue = 400m,
                            TypePayment = 3
                        ...
                        new
                        {
                            ...
                            Discount = 50m,
                            EmployeeId = 2,
                            SaleDate = new DateTime(2024, 9, 4, 16, 9, 27, 472, DateTimeKind.Local).AddTicks(8214),
                            StatusPayment = 0,
                            StatusSale = 0,
                            TotalValue = 600m,
                            TypePayment = 1
